...
$sql_checkfileName = "SELECT DISTINCT	FILES_NAMES FROM DIGITALTENKO_FEEDBACKDRIVER WHERE FILES_NAMES = ? ";
$params_checkfileName = array($fileName);
$query_checkfileName = sqlsrv_query( $conn, $sql_checkfileName, $params_checkfileName);
$result_checkfileName = sqlsrv_fetch_array($query_checkfileName, SQLSRV_FETCH_ASSOC);
if($result_checkfileName["FILES_NAMES"] != ""){
  echo "ERROR"; 
}else{
